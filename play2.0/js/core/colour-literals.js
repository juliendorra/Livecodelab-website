...
define(function() {
  ...
  ColourLiterals = (function() {
    ...
    ColourLiterals.prototype.addToScope = function(scope) {
      var colorName, colorValue, val, _ref, _results;
      _ref = this.colourNamesValues;
      _results = [];
      for (colorName in _ref) {
        colorValue = _ref[colorName];
        ...
        if (isNaN(val)) {
          _results.push(scope.add("" + colorName, colorValue));
        } else {
          _results.push(scope.add("" + colorName, val));
        }
      }
      return _results;
    };
...
/*
//@ sourceMappingURL=colour-literals.js.map
*/