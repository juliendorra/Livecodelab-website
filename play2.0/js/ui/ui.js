...
define(['jquery', 'sooperfish', 'sooperfish-easing', 'simplemodal'], function($) {
  var Ui;
  Ui = (function() {
    Ui.backgroundCanvasFractionOfWindowSize = 10;

    Ui.foregroundCanvasFractionOfWindowSize = 1.5;
    ...
    function Ui(eventRouter, stats, programLoader) {
      ...
      this.eventRouter.addListener("report-runtime-or-compile-time-error", function(e) {
        return _this.checkErrorAndReport(e);
      });
      this.eventRouter.addListener("clear-error", function() {
    ...
    Ui.prototype.setup = function() {
      ...
      return $(document).ready(function() {
        ...
        $('<span >LiveCodeLab 2.0</span>').appendTo($('<li>').appendTo($('#nav'))).click(function() {
          $("#aboutWindow").modal();
        ...
        $('<span >Hide Code: off</span>').appendTo($('<li>').appendTo($('#nav'))).attr('id', 'dimCodeButtonContainer');
        ...
        return _this.constructor.adjustCodeMirrorHeight();
      });
    };
