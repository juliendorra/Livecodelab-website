...
define(function() {
  ...
  ColourFunctions = (function() {
    ...
    ColourFunctions.prototype.addToScope = function(scope) {
      var _this = this;
      scope.add('color', function(a, b, c, d) {
        return _this.color(a, b, c, d);
      });
      scope.add('colorToHSB', function(a) {
        return _this.colorToHSB(a);
      });
      scope.add('brightness', function(a) {
        return _this.brightness(a);
      });
      scope.add('saturation', function(a) {
        return _this.saturation(a);
      });
      scope.add('hue', function(a) {
        return _this.hue(a);
      });
      scope.add('redF', function(a) {
        return _this.redF(a);
      });
      scope.add('greenF', function(a) {
        return _this.greenF(a);
      });
      scope.add('blueF', function(a) {
        return _this.blueF(a);
      });
      scope.add('alpha', function(a) {
        return _this.alpha(a);
      });
      scope.add('alphaZeroToOne', function(a) {
        return _this.alphaZeroToOne(a);
      });
      scope.add('lerp', function(a, b, c) {
        return _this.lerp(a, b, c);
      });
      scope.add('lerpColor', function(a, b, c) {
        return _this.lerpColor(a, b, c);
      });
      scope.add('colorMode', function(a, b, c, d, e) {
        return _this.lerpColor(a, b, c, d, e);
      });
      scope.add('blendColor', function(a, b, c) {
