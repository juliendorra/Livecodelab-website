...
define(['core/animation-loop', 'core/background-painter', 'core/blend-controls', 'core/code-compiler', 'core/colour-functions', 'core/colour-literals', 'core/graphics-commands', 'core/lights-commands', 'core/matrix-commands', 'core/program-runner', 'core/renderer', 'core/threejs-system', 'core/time-keeper', 'core/global-scope', 'sound/samplebank', 'sound/sound-system', 'bowser', 'buzz', 'lowLag', 'threejs', 'three-resize', 'Three.Detector', 'Three.ShaderExtras', 'Three.EffectComposer', 'Three.MaskPass', 'Three.RenderPass', 'Three.SavePass', 'Three.ShaderPass'], function(AnimationLoop, BackgroundPainter, BlendControls, CodeCompiler, ColourFunctions, ColourLiterals, GraphicsCommands, LightsCommands, MatrixCommands, ProgramRunner, Renderer, ThreeJsSystem, TimeKeeper, GlobalScope, SampleBank, SoundSystem, createBowser, buzz, lowLag, THREE, THREEx, Detector) {
  var LiveCodeLabCore;
  LiveCodeLabCore = (function() {
    function LiveCodeLabCore(paramsObject) {
      ...
      this.graphicsCommands = new GraphicsCommands(this.three, this, this.colourLiterals);
      ...
      this.drawFunctionRunner.addToScope(this.globalscope);
    }
    ...
    LiveCodeLabCore.prototype.updateCode = function(updatedCode) {
      this.codeCompiler.updateCode(updatedCode);
      if (updatedCode !== "" && this.dozingOff) {
        this.dozingOff = false;
        this.animationLoop.animate();
        return this.paramsObject.eventRouter.emit("livecodelab-waking-up");
      }
    };
...
/*
//@ sourceMappingURL=livecodelab-core.js.map
*/