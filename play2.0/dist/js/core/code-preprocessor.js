...
define(['core/code-preprocessor-tests', 'core/colour-literals'], function(CodePreprocessorTests, ColourLiterals) {
  ...
  return CodePreprocessor = (function() {
    ...
    */
    ...
    CodePreprocessor.prototype.adjustFunctionalReferences = function(code, error, userDefinedFunctions) {
    ...
    */
    ...
    CodePreprocessor.prototype.preprocess = function(code, bracketsVariables) {
      var a, bracketsVariablesArray, codeWithoutStringsOrComments, error, ignore, stringsTable, userDefinedFunctions, userDefinedFunctionsWithArguments, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref27, _ref28, _ref29, _ref3, _ref30, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      error = void 0;
      if (detailedDebug) {
      ...
      _ref20 = this.adjustFunctionalReferences(code, error, userDefinedFunctions), code = _ref20[0], error = _ref20[1];
      if (detailedDebug) {
      ...
      _ref30 = this.injectStrings(code, stringsTable, error), code = _ref30[0], error = _ref30[1];
      if (detailedDebug) {
        console.log("preprocess-29\n" + code + " error: " + error);
      }
